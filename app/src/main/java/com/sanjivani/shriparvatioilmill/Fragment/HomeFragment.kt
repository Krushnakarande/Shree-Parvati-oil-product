...
import com.sanjivani.shriparvatioilmill.MenuBottomSheetFragment
import com.sanjivani.shriparvatioilmill.R
import com.sanjivani.shriparvatioilmill.adapter.PopularAdaptar
import com.sanjivani.shriparvatioilmill.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        imageList.add(SlideModel(R.drawable.ads1,ScaleTypes.FIT))
        imageList.add(SlideModel(R.drawable.ads2,ScaleTypes.FIT))
        imageList.add(SlideModel(R.drawable.ads3,ScaleTypes.FIT))
        imageList.add(SlideModel(R.drawable.ads4,ScaleTypes.FIT))

        imageList.add(SlideModel(R.drawable.ads5,ScaleTypes.FIT))
        imageList.add(SlideModel(R.drawable.ads6,ScaleTypes.FIT))
        ...
        val adaptar = PopularAdaptar(foodName,Price,popularItemImages,requireContext())
