...
import com.sanjivani.shriparvatioilmill.databinding.FragmentSearchBinding
...
class SearchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        adapter = MenuAdapter(filteredMenuItemName,filteredMenuItemPrice,filteredMenuItemImage,requireContext())
